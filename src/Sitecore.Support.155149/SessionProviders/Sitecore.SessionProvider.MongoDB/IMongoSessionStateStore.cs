...
namespace Sitecore.Support.SessionProvider.MongoDB
{
  ...
  internal interface IMongoSessionStateStore
  {
    ...
    [CanBeNull]
    SessionStateStoreData GetItem([NotNull] string application, [NotNull] string id, out SessionStateLockCookie lockCookie, out int flags);
    ...
    /// </remarks>
    [CanBeNull]
    SessionStateStoreData GetItemExclusive([NotNull] string application, [NotNull] string id, [NotNull] SessionStateLockCookie lockCookie, out int flags);
    ...
    [CanBeNull]
    SessionStateStoreData GetExpiredItemExclusive([NotNull] string application, DateTime signalTime, [NotNull] SessionStateLockCookie lockCookie, out string id);
    ...
    /// </returns>
    [CanBeNull]
    SessionStateLockCookie GetItemLock([NotNull] string application, [NotNull] string id);
